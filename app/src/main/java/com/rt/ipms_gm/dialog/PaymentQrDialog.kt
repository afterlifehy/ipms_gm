...
import com.rt.ipms_gm.databinding.DialogPaymentQrBinding
...
class PaymentQrDialog(var qr: String, var amount: String) : VBBaseLibDialog<DialogPaymentQrBinding>(
    ...
    val colors = intArrayOf(com.rt.ipms_gm.R.color.white, com.rt.ipms_gm.R.color.white, com.rt.ipms_gm.R.color.white)
